            ...
            <div className="flex gap-2.5">
              {SOCIAL.map((s) => (
                <span
                  key={s.label}
                  aria-label={s.label}
                  className="w-[38px] h-[38px] rounded-[10px] bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-white/50 hover:bg-saffron-500 hover:text-white hover:border-saffron-500 transition-all duration-300 cursor-pointer"
                >
                  {s.svg}
                </span>
              ))}
